...
public enum PriceStreamMessageType {
	...
	HEARTBEAT(PricingHeartbeat.class), PRICE(Price.class);

	@Getter
	private final Class<? extends PriceStreamMessage> priceStreamMessageClass;

	private static final Map<Class<? extends PriceStreamMessage>, PriceStreamMessageType> CONSTANTS = new HashMap<>();
	 ...
	 */
	@JsonCreator
	public static PriceStreamMessageType fromPriceStreamMessageClass(Class<? extends PriceStreamMessage> priceStreamMessageClass) {
